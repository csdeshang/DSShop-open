...
class Membergoodsbrowse extends BaseMember {
    ...
    public function listinfo() {
        ...
        if ($gc_id > 0) {
            $where[] = array('gc_id_' .  $gc_depth,'=',$gc_id);
        }
        ...
        if ($browselist) {
            $goods_list_tmp = model('goods')->getGoodsList(array(array('goods_id','in', array_keys($browselist))), 'goods_id, goods_name, goods_promotion_price,goods_promotion_type, goods_marketprice, goods_image, gc_id, gc_id_1, gc_id_2, gc_id_3');
            $goods_list = array();
