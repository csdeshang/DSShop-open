...
$lang['seo_set_prompt'] 	= '插入的变量必需包括花括号“{}”，比如 {sitename}，当应用范围不支持该变量时，该变量将不会在前台显示(变量后边的分隔符也不会显示)，留空为系统默认设置，SEO自定义支持手写。';
...
$lang['seo_set_tips4'] 	= '名称 {shopname}，（应用范围：页）';
$lang['seo_set_tips5'] 	= '关键词 {key}，（应用范围：商品关键词、文章关键词、关键词）';
$lang['seo_set_tips6'] 	= '简单描述 {description}，（应用范围：商品描述、文章摘要、关键词）';
$lang['seo_set_group_content'] 		= '抢购内容';
$lang['seo_set_brand_list'] 		= '某一品牌商品列表';
$lang['seo_set_point_content'] 		= '积分中心商品内容';
$lang['seo_set_article_list'] 		= '文章分类列表';
$lang['seo_set_article_content'] 	= '文章内容';
