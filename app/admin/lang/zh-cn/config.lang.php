...
$lang['member_normal_register'] = '用户普通注册';
$lang['member_normal_register_notice'] = '用户可以使用普通注册和手机注册，手机注册需在邮箱短信菜单中设置';
$lang['promotion_allow'] = '商品促销';
$lang['promotion_notice'] = '启用商品促销功能后，商家可以通过秒杀、满即送、优惠套装和推荐展位活动，对店铺商品进行促销';
...
$lang['points_signin_isuse'] = '签到送积分';
$lang['points_signin_isuse_notice'] = '积分功能以及签到送积分启用后，会员才可以进行签到';
...
$lang['member_auth_notice'] = '启用后，用户只有通过实名认证审核才可以下单';
...
$lang['mapak_type'] = '地图接口类型';
$lang['gaode_map'] = '高德地图';
$lang['gaode_ak'] = '高德地图key';
$lang['gaode_jscode'] = '高德地图安全密钥';
$lang['baidu_map'] = '百度地图';
$lang['baidu_mapservice_ak_key'] = '百度地图服务端AK密钥';
$lang['baidu_map_ak_key'] = '百度地图浏览器端AK密钥';
...
$lang['customer_service_open'] = '允许开启客服';
$lang['customer_service_qq'] = 'QQ客服';
$lang['customer_service_ww'] = '旺旺客服';

$lang['h5_site_url'] = '手机端地址';
$lang['h5_force_redirect'] = '手机端强制跳转';
