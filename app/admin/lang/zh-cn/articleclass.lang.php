...
$lang['article_class_index_tips1']              = '您可以点击分类名称右边的新增下级来直接给该分类添加下级分类';
$lang['article_class_index_tips2']		= '默认的文章分类不可以删除';
$lang['ac_name_tips']		= '分类名称';
/**
 * 新增分类
 */
$lang['article_class_add']	= '新增分类';
