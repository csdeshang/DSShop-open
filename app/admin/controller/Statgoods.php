...
class Statgoods extends AdminControl
{
    ...
    public function goods_sale(){
        ...
        $field = 'goods_id,goods_name,goods_commonid,SUM(goods_num) as goodsnum,COUNT(DISTINCT order_id) as ordernum,SUM(goods_pay_price) as goodsamount';
        //排序
        ...
        if (input('param.exporttype') == 'excel'){
            ...
            //查询品牌
            $brand_list = model('brand')->getBrandList(array());
